...
namespace Co1umbine.InteractionMotion
{
    ...
    {
        public KeyCode startStopKey = KeyCode.R;
        public Animator sourceLeaderAnimator;
        public Animator sourceFollowerAnimator;

        [Tooltip("Player of generated interaction follower motion. If left blank, it will be ignored.")]
        public MotionDataPlayerCore motionPlayer;
        [Tooltip("Bone position indicator of generated interaction follower motion. If left blank, it will be ignored.")]
        public PositionDataPlayerCore positionPlayer;
        [Tooltip("Player of generated interaction leader motion. If left blank, it will be ignored.")]
        public MotionDataPlayerCore leaderMotionPlayer;
        [Tooltip("Bone position indicator of generated interaction leader motion. If left blank, it will be ignored.")]
        public PositionDataPlayerCore leaderPositionPlayer;

        public float TargetFPS = 30;

        [Tooltip("Delay time after the start key is pressed")]
